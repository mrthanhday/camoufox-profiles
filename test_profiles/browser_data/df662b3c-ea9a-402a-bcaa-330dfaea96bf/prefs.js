...
user_pref("app.update.lastUpdateTime.addon-background-update-timer", 1777964701);
user_pref("app.update.lastUpdateTime.browser-cleanup-thumbnails", 1777964701);
user_pref("app.update.lastUpdateTime.region-update-timer", 1777964701);
user_pref("app.update.lastUpdateTime.services-settings-poll-changes", 1777964701);
user_pref("app.update.lastUpdateTime.telemetry_modules_ping", 1777964730);
user_pref("app.update.lastUpdateTime.telemetry_untrustedmodules_ping", 0);
user_pref("app.update.lastUpdateTime.xpi-signature-verification", 1777964701);
...
user_pref("browser.newtabpage.activity-stream.impressionId", "{b978e870-6d89-4694-bb86-7afc589e9ab7}");
...
user_pref("browser.startup.lastColdStartupCheck", 1777964900);
...
user_pref("captchadetection.lastSubmission", 1777964);
...
user_pref("extensions.formautofill.creditCards.reauth.optout", "MDIEEPgAAAAAAAAAAAAAAAAAAAEwFAYIKoZIhvcNAwcECL0rTBygcb0fBAgNC0l6Wd+95Q==");
...
user_pref("extensions.webextensions.uuids", "{\"formautofill@mozilla.org\":\"fdd19eb2-2a4f-46b8-a382-90743faac559\",\"pictureinpicture@mozilla.org\":\"7cbd7b8f-5b19-4d65-9935-b9c6a01f70a2\",\"screenshots@mozilla.org\":\"c1f930e0-125e-4d6d-810e-585441635b0a\",\"webcompat@mozilla.org\":\"3902a6d5-4e58-48f2-9e20-0859e624ef4b\",\"firefox-compact-dark@mozilla.org\":\"8400a56b-386a-4d07-a454-8bb1407ca7ef\",\"addons-search-detection@mozilla.com\":\"321a4ee9-a456-413a-9801-3e613c081eea\",\"uBlock0@raymondhill.net\":\"ffc72cd4-1c90-4af4-8430-a44991cc3f57\"}");
...
user_pref("media.gmp-manager.lastCheck", 1777964851);
user_pref("media.gmp-manager.lastEmptyCheck", 1777964851);
...
user_pref("sanity-test.device-id", "0x1f82");
user_pref("sanity-test.driver-version", "32.0.15.7196");
...
user_pref("signon.management.page.os-auth.optout", "MDIEEPgAAAAAAAAAAAAAAAAAAAEwFAYIKoZIhvcNAwcECFAi66pY5owoBAgYC/NoSC/Wlw==");
user_pref("toolkit.startup.last_success", 1777964898);
